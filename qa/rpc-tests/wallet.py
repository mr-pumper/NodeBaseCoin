...
#   c) node1 mines 32 blocks, so now node 0 has 60001ndb, node 1 has 4250ndb, node2 has none.
#   d) node0 sends 601 ndb to node2, in two transactions (301 ndb, then 300 ndb).
