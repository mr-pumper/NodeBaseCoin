Contributing to Nodebase Core
============================

The Nodebase Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodebase Core project, and is not to be
confused with overall Nodebase Network Protocol consensus changes.

Whether a pull request is merged into Nodebase Core rests with the project merge
...
Patches that change Nodebase consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nodebase consensus, it must have been
...
The project leader is the release manager for each Nodebase Core release.
