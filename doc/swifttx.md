...
This mechanism has been integrated into Bitcore-Node-Nodebase which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Nodebase-Project/insight-api-nodebase#web-socket-api](https://github.com/Nodebase-Project/insight-api-nodebase#web-socket-api)
* API: [https://github.com/Nodebase-Project/insight-api-nodebase#swifttx-transactions](https://github.com/Nodebase-Project/insight-api-nodebase#swifttx-transactions)
...
By default, the Nodebase Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nodebase Core daemon:
