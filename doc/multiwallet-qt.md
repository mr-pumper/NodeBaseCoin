...
In order to support loading of multiple wallets in nodebase-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodebase.cpp.
...
Changes to nodebase.cpp
----------------------
nodebase.cpp is the entry point into nodebase-qt, and as such, will require some minor modifications to provide hooks for
