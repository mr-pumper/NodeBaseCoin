...
RESOURCES += src/qt/nodebase.qrc src/qt/nodebase_locale.qrc

TRANSLATIONS += src/qt/locale/nodebase_bg.ts \
                src/qt/locale/nodebase_de.ts \
                src/qt/locale/nodebase_en.ts \
                src/qt/locale/nodebase_es.ts \
                src/qt/locale/nodebase_fi.ts \
                src/qt/locale/nodebase_fr.ts \
                src/qt/locale/nodebase_it.ts \
                src/qt/locale/nodebase_ja.ts \
                src/qt/locale/nodebase_pl.ts \
                src/qt/locale/nodebase_pt.ts \
                src/qt/locale/nodebase_ru.ts \
                src/qt/locale/nodebase_sk.ts \
                src/qt/locale/nodebase_sv.ts \
                src/qt/locale/nodebase_vi.ts \
                src/qt/locale/nodebase_zh_CN.ts \
                src/qt/locale/nodebase_zh_TW.ts
