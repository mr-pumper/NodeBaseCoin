...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nodebase Core nodebase-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodebase-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodebase transaction") + "\n" +
                               "  nodebase-tx [options] -create [commands]   " + _("Create hex-encoded nodebase transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodebase transaction
