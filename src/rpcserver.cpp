...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Nodebase server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Nodebase server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nodebase features */
        {"nodebase", "masternode", &masternode, true, true, false},
        {"nodebase", "listmasternodes", &listmasternodes, true, true, false},
        {"nodebase", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodebase", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodebase", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodebase", "masternodedebug", &masternodedebug, true, true, false},
        {"nodebase", "startmasternode", &startmasternode, true, true, false},
        {"nodebase", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodebase", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodebase", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodebase", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodebase", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodebase", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodebase", "mnbudget", &mnbudget, true, true, false},
        {"nodebase", "preparebudget", &preparebudget, true, true, false},
        {"nodebase", "submitbudget", &submitbudget, true, true, false},
        {"nodebase", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodebase", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodebase", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodebase", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodebase", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodebase", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodebase", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodebase", "checkbudgets", &checkbudgets, true, true, false},
        {"nodebase", "mnsync", &mnsync, true, true, false},
        {"nodebase", "spork", &spork, true, true, false},
        {"nodebase", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nodebase", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> nodebase-cli " + methodname + " " + args + "\n";
}
