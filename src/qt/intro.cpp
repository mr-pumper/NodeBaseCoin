...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Nodebase Core"),
     ...
     * override -datadir in the nodebase.conf file in the default data directory
     * (to be consistent with nodebased behavior)
     */
    if (dataDir != getDefaultDataDirectory())
