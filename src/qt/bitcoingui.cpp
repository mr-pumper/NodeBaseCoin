                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nodebase Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodebase address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodebase: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNDB"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nodebase Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodebase Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodebase"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodebase addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodebase addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nodebase: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodebase Core help message to get a list with possible Nodebase command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nodebase Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodebase network", "", count));
}
...
{
    QString strTitle = tr("Nodebase Core"); // default title
