...
public:
    ...
    void setZNdbControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNDB_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNDB_clicked();
    void on_pushButtonZNdbControl_clicked();
