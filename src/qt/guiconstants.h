...
/* Nodebase GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nodebase"
#define QAPP_ORG_DOMAIN "nodebase.tech"
#define QAPP_APP_NAME_DEFAULT "Nodebase-Qt"
#define QAPP_APP_NAME_TESTNET "Nodebase-Qt-testnet"
