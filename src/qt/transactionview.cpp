 ...
 */
    ...
    typeWidget->addItem(tr("Received Ndb from zNdb"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNdb"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNdb));
