...
/** Utility functions used by the Nodebase Qt UI.
 */
namespace GUIUtil
{
...
// Render Nodebase addresses in monospace font
...
// Parse "nodebase:" URI into recipient object, return true on successful parsing
