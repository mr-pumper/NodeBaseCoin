/* src/config/nodebase-config.h.  Generated from nodebase-config.h.in by configure.  */
/* src/config/nodebase-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "nodebase.tech"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nodebase Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nodebase Core 2.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nodebase"
